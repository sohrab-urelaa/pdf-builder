<template>
    ...
    >
        <div class="flex space-x-2 items-end">
            <div
                class="group/contenteditable-container bg-base-200 rounded-md p-2 border border-base-300 w-full flex justify-between items-end"
            >
                <div class="flex items-center space-x-2">
                    ...
                    <Contenteditable
                        ...
                        :icon-width="18"
                        @update:model-value="
                            $emit('name-change', selectedSubmitter)
                        "
                    />
                </div>
            </div>
            <div class="dropdown bg-base-200 dropdown-top dropdown-end">
                <label
                    tabindex="0"
                    class="bg-base-200 cursor-pointer rounded-md p-2 border border-base-300 w-full flex justify-center"
                >
                ...
                >
                    ...
                    <li v-if="submitters.length < names.length && editable">
                        ...
                        >
                            <IconUserPlus :width="20" :stroke-width="1.6" />
                            <span class="py-1">
    ...
    >
        ...
        <ul
            ...
            @click="closeDropdown"
        >
            <li v-for="(submitter, index) in submitters" :key="submitter.uuid">
                <a
                    href="#"
                    class="flex px-2 group justify-between items-center"
                    :class="{
                        active: submitter === selectedSubmitter,
                        'py-0.5': submitters.length > 8,
                    }"
                    @click.prevent="selectSubmitter(submitter)"
                >
                    <span class="py-1 flex items-center">
                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                @click.prevent.stop="
                                    [move(submitter, -1), $refs.label.focus()]
                                "
                            >
                                ▲
                            </button>
            ...
            <li
                v-if="
                    submitters.length < names.length && editable && allowAddNew
                "
            >
...
export default {
    ...
    props: {
        ...
        menuClasses: {
            ...
            required: false,
            default:
                "dropdown-content bg-base-200  menu p-2 shadow rounded-box w-full z-10",
        },
    },
