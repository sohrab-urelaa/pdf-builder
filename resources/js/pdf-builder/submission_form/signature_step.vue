    ...
    <div dir="auto" class="relative">
        ...
        >
            ...
            <div class="space-x-2 flex">
                <span
                    v-if="
                        isTextSignature && field.preferences?.format !== 'typed'
                    "
                    class="tooltip"
                ...
                >
                    <a
                        ...
                        :class="{
                            'btn-outline': !isShowQr,
                            'text-white': isShowQr,
                        }"
                        @click.prevent="
                            isShowQr
                                ? hideQr()
                                : [(isTextSignature = false), showQr()]
                        "
                    >
                        <IconQrcode :width="19" :height="19" />
                    </a>
                </span>
                <a
                    href="#"
        ...
        <div class="relative">
            ...
            >
                ...
                <div class="flex items-center justify-center w-full h-full p-4">
                    <div class="bg-white p-4 rounded-xl h-full">
                        <canvas
                            ref="qrCanvas"
                            class="h-full"
                            width="132"
...
export default {
    ...
    inject: ["baseUrl", "t", "signatureUploaded"],
    props: {
        field: {
            type: Object,
            required: true,
        ...
        maybeSetSignedUuid(signedUuid) {
            try {
                if (
                    ...
                    const values = window.localStorage.getItem(
                        "signed_signature_uuids"
                    );
